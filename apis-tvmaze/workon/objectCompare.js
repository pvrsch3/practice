function sameArrays(arr1, arr2) {
    // return true if every value is the same in 
    //the other at the specified index
    if (arr1.length !== arr2.length) return false;
    // make sure that every value in the array is
    //the same as the other at the same index
    return arr1.every((val, idx) => {
      ...
      // arrays with objects in them, call our 
      //sameObjects function
  ...
  //if obj1 & obj2 are arrays, return same arrays
  //otherwise, return same objects
